(function (global, factory) {
  ...
  */
    ...
    var parsePath$1 = function parsePath(path) {
        var pathname = path || '/';
        var search = '';
        var hash = '';
    ...
    var createPath$1 = function createPath(location) {
        var pathname = location.pathname,
            search = location.search,
            hash = location.hash;
    ...
    var createLocation$1 = function createLocation(path, state, key, currentLocation) {
        var location = void 0;
        if (typeof path === 'string') {
            // Two-arg form: push(path, state)
    ...
    var locationsAreEqual$1 = function locationsAreEqual(a, b) {
    ...
    var createTransitionManager$1 = function createTransitionManager() {
        ...
        var setPrompt = function setPrompt(nextPrompt) {
            warning_1$3(prompt == null, 'A history supports only one prompt at a time');
            ...
            if (prompt != null) {
                ...
                if (typeof result === 'string') {
                    if (typeof getUserConfirmation === 'function') {
                        ...
                        warning_1$3(false, 'A history needs a getUserConfirmation function in order to use a prompt message');
    ...
    var createBrowserHistory = function createBrowserHistory() {
        ...
        invariant_1$1(canUseDOM$1, 'Browser history needs a DOM');
        ...
        var getDOMLocation = function getDOMLocation(historyState) {
            ...
            warning_1$3(!basename || hasBasename(path, basename), 'You are attempting to use a basename on a page whose URL path does not begin ' + 'with the basename. Expected path "' + path + '" to begin with "' + basename + '".');
        ...
        var push = function push(path, state) {
            warning_1$3(!((typeof path === 'undefined' ? 'undefined' : _typeof$3(path)) === 'object' && path.state !== undefined && state !== undefined), 'You should avoid providing a 2nd state argument to push when the 1st ' + 'argument is a location-like object that already has state; it is ignored');
            ...
            transitionManager.confirmTransitionTo(location, action, getUserConfirmation, function (ok) {
                ...
                if (canUseHistory) {
                    ...
                    warning_1$3(state === undefined, 'Browser history cannot push state in browsers that do not support HTML5 history');
        ...
        var replace = function replace(path, state) {
            warning_1$3(!((typeof path === 'undefined' ? 'undefined' : _typeof$3(path)) === 'object' && path.state !== undefined && state !== undefined), 'You should avoid providing a 2nd state argument to replace when the 1st ' + 'argument is a location-like object that already has state; it is ignored');
            ...
            transitionManager.confirmTransitionTo(location, action, getUserConfirmation, function (ok) {
                ...
                if (canUseHistory) {
                    ...
                    warning_1$3(state === undefined, 'Browser history cannot replace state in browsers that do not support HTML5 history');
    ...
    var createHashHistory = function createHashHistory() {
        ...
        invariant_1$1(canUseDOM$1, 'Hash history needs a DOM');
        ...
        var allPaths = [createPath$1(initialLocation)];
        ...
        var push = function push(path, state) {
            warning_1$3(state === undefined, 'Hash history cannot push state; it is ignored');
            ...
            transitionManager.confirmTransitionTo(location, action, getUserConfirmation, function (ok) {
                ...
                if (hashChanged) {
                    ...
                    warning_1$3(false, 'Hash history cannot PUSH the same path; a new entry will not be added to the history stack');
        ...
        var replace = function replace(path, state) {
            warning_1$3(state === undefined, 'Hash history cannot replace state; it is ignored');
        ...
        var go = function go(n) {
            warning_1$3(canGoWithoutReload, 'Hash history go(n) causes a full page reload in this browser');
  ...
  */
    ...
    var BrowserRouter = function (_React$Component) {
        inherits$1(BrowserRouter, _React$Component);

        function BrowserRouter() {
            var _temp, _this, _ret;

            classCallCheck$1(this, BrowserRouter);

            for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
                args[_key] = arguments[_key];
            }

            return _ret = (_temp = (_this = possibleConstructorReturn$1(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = createBrowserHistory(_this.props), _temp), possibleConstructorReturn$1(_this, _ret);
        }
    ...
    var HashRouter = function (_React$Component) {
        inherits$1(HashRouter, _React$Component);

        function HashRouter() {
            var _temp, _this, _ret;

            classCallCheck$1(this, HashRouter);

            for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
                args[_key] = arguments[_key];
            }

            return _ret = (_temp = (_this = possibleConstructorReturn$1(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = createHashHistory(_this.props), _temp), possibleConstructorReturn$1(_this, _ret);
        }
    ...
    var Link = function (_React$Component) {
        inherits$1(Link, _React$Component);
        ...
        Link.prototype.render = function render() {
            ...
            var _props = this.props,
                ...
                to = _props.to,
                props = objectWithoutProperties$1(_props, ["innerRef", "replace", "to"]); // eslint-disable-line no-unused-vars
            ...
            return React.createElement(
                ...
                function (context$$1) {
                    ...
                    return React.createElement("a", _extends$7({}, props, {
    ...
    function NavLink(_ref) {
        var ariaCurrent = _ref["aria-current"],
            ...
            to = _ref.to,
            rest = objectWithoutProperties$1(_ref, ["aria-current", "activeClassName", "activeStyle", "className", "exact", "isActive", "location", "strict", "style", "to"]);

        var path = (typeof to === "undefined" ? "undefined" : _typeof$5(to)) === "object" ? to.pathname : to;
